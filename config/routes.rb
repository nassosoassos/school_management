ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :groups, :member => { :subscribe_to_semester=>:post, :semester_subscription=>:get, :show_group_semester=>:post, :grades=>:get, :update_grades=>:post, :select_subject=>:post, :list_grades=>:post, :debug=>:get, :lists=>:get, :print_lists=>:get } 
