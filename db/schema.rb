...
ActiveRecord::Schema.define(:version => 20121213090103) do
  ...
  add_index "san_semesters", ["number", "academic_year_id"], :name => "number_academic_year", :unique => true, :limit => {"number"=>nil, "academic_year_id"=>nil}
