...
ActiveRecord::Schema.define(:version => 20121206100340) do
  ...
  add_index "cce_reports", ["observable_id", "student_id", "batch_id", "exam_id", "observable_type"], :name => "cce_report_join_index", :limit => {"observable_id"=>nil, "observable_type"=>nil, "batch_id"=>nil, "student_id"=>nil, "exam_id"=>nil}
  ...
  add_index "san_subjects", ["title", "kind"], :name => "title_kind_index", :unique => true, :limit => {"title"=>nil, "kind"=>nil}
