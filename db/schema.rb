...
ActiveRecord::Schema.define(:version => 20121206100340) do
  ...
  add_index "cce_reports", ["observable_id", "student_id", "batch_id", "exam_id", "observable_type"], :name => "cce_report_join_index", :limit => {"observable_type"=>nil, "observable_id"=>nil, "student_id"=>nil, "exam_id"=>nil, "batch_id"=>nil}
  ...
  add_index "semester_subjects", ["semester_id", "subject_id"], :name => "index_semester_subjects_on_semester_id_and_subject_id", :unique => true, :limit => {"semester_id"=>nil, "subject_id"=>nil}
  ...
  add_index "students_subjects", ["student_id", "semester_subjects_id", "san_semester_id"], :name => "student_subject_semester", :unique => true, :limit => {"student_id"=>nil, "san_semester_id"=>nil, "semester_subjects_id"=>nil}
