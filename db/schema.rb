...
ActiveRecord::Schema.define(:version => 20121127081217) do
  ...
  add_index "academic_years", ["start_date"], :name => "start_date_index", :unique => true, :limit => {"start_date"=>nil}
  ...
  add_index "cce_reports", ["observable_id", "student_id", "batch_id", "exam_id", "observable_type"], :name => "cce_report_join_index", :limit => {"exam_id"=>nil, "observable_id"=>nil, "student_id"=>nil, "batch_id"=>nil, "observable_type"=>nil}
  ...
  create_table "groups", :force => true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.boolean  "graduated",          :default => true
    t.integer  "active_semester_id"
    t.integer  "san_semester_id"
  end
  ...
  create_table "old_student_semesters", :force => true do |t|
  ...
  create_table "san_semesters", :force => true do |t|
    t.integer  "number"
    t.integer  "group_id"
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "mil_p_weight"
    t.integer  "academic_year_id"
    t.string   "old_id"
  end

  create_table "san_subjects", :force => true do |t|
    t.string   "title"
    t.string   "kind"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "san_subjects", ["title", "kind"], :name => "title_kind_index", :unique => true, :limit => {"kind"=>nil, "title"=>nil}
  ...
  create_table "semester_subjects", :force => true do |t|
  ...
  add_index "semester_subjects", ["semester_id", "subject_id"], :name => "index_semester_subjects_on_semester_id_and_subject_id", :unique => true, :limit => {"subject_id"=>nil, "semester_id"=>nil}
  add_index "semester_subjects", ["semester_id"], :name => "index_semester_subjects_on_semester_id", :limit => {"semester_id"=>nil}
  add_index "semester_subjects", ["subject_id"], :name => "index_semester_subjects_on_subject_id", :limit => {"subject_id"=>nil}
  ...
  create_table "student_languages", :force => true do |t|
  ...
  create_table "student_military_performances", :force => true do |t|
    t.float    "grade"
    t.integer  "student_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    ...
    t.float    "univ_points"
    t.float    "mil_points"
    t.float    "mil_p_points"
    t.integer  "n_unfinished_subjects"
    t.integer  "success_type"
    t.float    "cum_gpa"
    t.float    "cum_points"
    t.float    "cum_univ_gpa"
    t.float    "cum_mil_gpa"
    t.float    "cum_mil_p_gpa"
    t.integer  "cum_n_unfinished_subjects"
    t.integer  "cum_seniority"
  end

  create_table "student_previous_datas", :force => true do |t|
    t.integer "student_id"
    t.string  "institution"
    t.integer "admission_points"
    t.integer "admission_rank"
  ...
  create_table "students_subjects", :force => true do |t|
    ...
    t.integer "academic_year_id"
    t.string  "old_id"
    t.integer "semester_subjects_id"
  end

  add_index "students_subjects", ["student_id", "semester_subjects_id", "san_semester_id"], :name => "student_subject_semester", :unique => true, :limit => {"semester_subjects_id"=>nil, "student_id"=>nil, "san_semester_id"=>nil}
  add_index "students_subjects", ["student_id", "subject_id", "academic_year_id"], :name => "student_subject_year_index", :unique => true, :limit => {"student_id"=>nil, "academic_year_id"=>nil, "subject_id"=>nil}
