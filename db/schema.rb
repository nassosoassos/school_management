...
ActiveRecord::Schema.define(:version => 20121130123103) do
  ...
  add_index "cce_reports", ["observable_id", "student_id", "batch_id", "exam_id", "observable_type"], :name => "cce_report_join_index", :limit => {"exam_id"=>nil, "batch_id"=>nil, "observable_type"=>nil, "student_id"=>nil, "observable_id"=>nil}
  ...
  add_index "students_subjects", ["student_id", "semester_subjects_id", "san_semester_id"], :name => "student_subject_semester", :unique => true, :limit => {"san_semester_id"=>nil, "student_id"=>nil, "semester_subjects_id"=>nil}
