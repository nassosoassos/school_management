...
ActiveRecord::Schema.define(:version => 20121214065238) do
  ...
  add_index "cce_reports", ["observable_id", "student_id", "batch_id", "exam_id", "observable_type"], :name => "cce_report_join_index", :limit => {"observable_id"=>nil, "exam_id"=>nil, "observable_type"=>nil, "batch_id"=>nil, "student_id"=>nil}
  ...
  add_index "students_subjects", ["student_id", "semester_subjects_id", "san_semester_id"], :name => "student_subject_semester", :unique => true, :limit => {"san_semester_id"=>nil, "semester_subjects_id"=>nil, "student_id"=>nil}
