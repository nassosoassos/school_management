...
ActiveRecord::Schema.define(:version => 20121214065238) do
  ...
  add_index "cce_reports", ["observable_id", "student_id", "batch_id", "exam_id", "observable_type"], :name => "cce_report_join_index", :limit => {"observable_id"=>nil, "batch_id"=>nil, "observable_type"=>nil, "student_id"=>nil, "exam_id"=>nil}
  ...
  add_index "san_semesters", ["number", "academic_year_id"], :name => "number_academic_year", :unique => true, :limit => {"academic_year_id"=>nil, "number"=>nil}
  ...
  add_index "students_subjects", ["student_id", "semester_subjects_id", "san_semester_id"], :name => "student_subject_semester", :unique => true, :limit => {"semester_subjects_id"=>nil, "san_semester_id"=>nil, "student_id"=>nil}
